...
namespace ProjectDbFirst.Controllers
{
    public class DeptsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeptId,DeptName,DeptDesc")] Dept dept)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeptId,DeptName,DeptDesc")] Dept dept)
        {
            if (id != dept.DeptId)
            {
                return NotFound();
