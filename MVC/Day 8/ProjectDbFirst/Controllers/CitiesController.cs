...
namespace ProjectDbFirst.Controllers
{
    public class CitiesController : Controller
    {
        ...
        {
            var eMPLOYEESContext = _context.Cities.Include(c => c.C);
        ...
        public async Task<IActionResult> Create([Bind("CityId,CityName,CId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,CityName,CId")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
